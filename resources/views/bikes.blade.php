			 ...
			 <div class="header">
				  ...
				  <div class="top-nav">										 
					   ...
					   <ul class="nav">
	                    ...
	                    @guest
	                        <li class="dropdown1"><a href="{{ route('login') }}">Login</a></li>
	                        <li class="dropdown1"><a href="{{ route('register') }}">Register</a></li>
	                    @else
	                        <li class="dropdown1">
...
<div class="bikes">		 
	 <div class="mountain-sec">
		...
		@foreach($Bikes as $Bike)
		 <a href="{{route(['bike',$Bike->id])}}"><div class="bike">				 
			 <img src="{{asset('images/'.$Bike->product_image_link) }}" alt=""/>
		     <div class="bike-cost">
					 <div class="bike-mdl">
						 <h4>NAME<span>{{$Bike->product_name}}</span></h4>
					 </div>
					 <div class="bike-cart">						 
						 <a class="buy" href="{{route('bike',['id' => $Bike->id])}}">BUY NOW</a>
					 </div>
					 <div class="clearfix"></div>
				 </div>
				 <div class="fast-viw">
						<a href="{{route(['bike',$Bike->id])}}">Quick View</a>
				 </div>
			 </div></a>
